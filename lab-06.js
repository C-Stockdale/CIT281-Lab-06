...
//console.log("1 " + atomicHabits.title);
...
/* // Create a book
const atomicHabits1 = new Book("Atomic Habits", "James Clear", "10/16/2018");
...
// Create a book
const atomicHabits2 = new Book("Atomic Habits", "James Clear", "10/16/2018");
...
// Create a book
const atomicHabits3 = new Book("Atomic Habits", "James Clear", "10/16/2018");

// Add book to library and output library count and books
library.addBook(atomicHabits2);
console.log(`Book count: ${library.count}`);
library.listBooks(); */
